...
public class KeywordsFlow extends FrameLayout implements OnGlobalLayoutListener{
    ...
    /** 存储显示的关键字。 */
    private Vector<Keyword> vecKeywords;
    ...
    private void init() {
        ...
        random = new Random();
        vecKeywords = new Vector<Keyword>(MAX);
    ...
    public boolean feedKeyword(Keyword keyword) {
...
//                txt.setBackgroundColor(Color.RED);
                ...
                int strWidth = (int) Math.ceil(paint.measureText(keyword.getDisplayName()));
