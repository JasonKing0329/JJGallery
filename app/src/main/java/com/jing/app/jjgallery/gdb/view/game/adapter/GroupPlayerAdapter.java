...
public class GroupPlayerAdapter extends RecyclerView.Adapter<GroupPlayerAdapter.PlayerHolder> implements View.OnClickListener
    ...
    public GroupPlayerAdapter(List<PlayerBean> list, IPlayerImageProvider imageProvider) {
        this.list = list;
    ...
    public interface OnPlayerItemListener {
        ...
        void onPlayerItemLongClick(GroupPlayerAdapter adapter, List<PlayerBean> list, int position);
    }
}
