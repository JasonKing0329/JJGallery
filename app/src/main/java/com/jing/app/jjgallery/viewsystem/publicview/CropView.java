...
public class CropView extends View implements OnTouchListener {
    ...
    public void initParams() {
        ...
        SIZE_BOARDER = getResources().getDimensionPixelSize(R.dimen.crop_boarder_size);
        SIZE_BOARDER_POINT = getResources().getDimensionPixelSize(R.dimen.crop_boarder_point_size);
        SIZE_CROP_AREA = getResources().getDimensionPixelSize(R.dimen.crop_side_area);
        COLOR_BOARDER = getResources().getColor(R.color.crop_stroke);
