...
public class SlidingAppCompatActivity extends AppCompatActivity implements SlidingActivityBase {

    private SlidingActivityHelper mHelper;

    /* (non-Javadoc)
     * @see android.support.v4.app.AppCompatActivity#onCreate(android.os.Bundle)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see android.support.v4.app.AppCompatActivity#onSaveInstanceState(android.os.Bundle)
     */
    @Override
    ...
    public void setSecondaryMenu(int res) {
        mHelper.setSecondaryMenu(res);
    }

    public void setSecondaryMenu(View view) {
        mHelper.setSecondaryMenu(view);
    }
